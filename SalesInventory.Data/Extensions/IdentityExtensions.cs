...
namespace SalesInventory.Data.Extensions
{
    ...
    public static class IdentityExtensions
    {
        ...
        public static ApplicationIdentityUser CopyAppUserProperties(this ApplicationIdentityUser applicationIdentityUser, ApplicationUser appUser)
        {
            ...
            applicationIdentityUser.LastLoginIp = appUser.LastLoginIp;
            applicationIdentityUser.LastLoginTime = appUser.LastLoginTime;
            applicationIdentityUser.JoiningDate = appUser.JoiningDate;
            applicationIdentityUser.ProfilePic = appUser.ProfilePic;
        ...
        public static ApplicationUser CopyApplicationIdentityUserProperties(this ApplicationUser appUser, ApplicationIdentityUser applicationIdentityUser)
        {
            ...
            appUser.LastLoginIp = applicationIdentityUser.LastLoginIp;
            appUser.LastLoginTime = applicationIdentityUser.LastLoginTime;
            appUser.JoiningDate = applicationIdentityUser.JoiningDate;
            appUser.ProfilePic = applicationIdentityUser.ProfilePic;
